...
<a href='#contact' style={{background:'#84CC16',color:'#fff',padding:'12px 20px',borderRadius:16,textDecoration:'none',fontWeight:'bold'}}>Book Call</a>
</header>

<section style={{maxWidth:1200,margin:'0 auto',padding:'80px 24px',display:'grid',gridTemplateColumns:'1.2fr 1fr',gap:40,alignItems:'center'}}>
<div>
<div style={{color:'#14B8A6',fontWeight:'bold',letterSpacing:3,fontSize:14}}>AI AUTOMATION AGENCY</div>
<h1 style={{fontSize:68,lineHeight:1.05,margin:'16px 0'}}>Never miss another lead</h1>
<p style={{fontSize:21,color:'#475569',maxWidth:620}}>Flow State Systems builds AI-powered automation that captures, qualifies, and follows up with leads instantly—so your business grows while you focus on what you do best.</p>
...
<section style={{borderTop:'1px solid #e2e8f0',borderBottom:'1px solid #e2e8f0',background:'#fff'}}>
<div style={{maxWidth:1200,margin:'0 auto',padding:'18px 24px',display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(180px,1fr))',gap:16,textAlign:'center',color:'#475569',fontWeight:'bold'}}>
<div>24/7 Follow-Up</div><div>More Booked Calls</div><div>Less Admin Work</div><div>Built to Scale</div>
</div>
</section>

<section id='services' style={{maxWidth:1200,margin:'0 auto',padding:'80px 24px'}}>
<h2 style={{fontSize:42,textAlign:'center'}}>What We Build</h2>
